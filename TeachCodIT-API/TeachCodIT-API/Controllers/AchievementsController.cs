...
namespace TeachCodIT_API.Controllers
{
    ...
    public class AchievementsController : ControllerBase
    {
        ...
        public AchievementsController(TeachCodItContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Achievement>> PostAchievement(Achievement achievement)
        {
            ...
            return CreatedAtAction("GetAchievement", new { id = achievement.IdAchievement }, achievement);
        }
        ...
        {
            return _context.Achievements.Any(e => e.IdAchievement == id);
        }
    }
}
