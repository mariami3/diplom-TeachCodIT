...
public partial class TeachCodItContext : DbContext
{
    ...
    public virtual DbSet<UserDailyLogin> UserDailyLogins { get; set; }

    public virtual DbSet<UserDailyQuest> UserDailyQuests { get; set; }

    public virtual DbSet<UserLessonCompletion> UserLessonCompletions { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DailyQuest>(entity =>
        {
            ...
            entity.Property(e => e.Description)
                .HasMaxLength(500)
                .IsUnicode(false);
            entity.Property(e => e.IncrementStep).HasDefaultValue(10);
            entity.Property(e => e.Title)
                .HasMaxLength(200)
                .IsUnicode(false);
            entity.Property(e => e.Type)
        ...
        modelBuilder.Entity<LessonTask>(entity =>
        {
            ...
            entity.Property(e => e.CheckerType)
                .HasMaxLength(50)
                .IsUnicode(false)
        ...
        modelBuilder.Entity<UserDailyLogin>(entity =>
        {
            entity.HasKey(e => e.IdDailyLogin).HasName("PK__UserDail__CEC8B4BFB3639FF8");

            entity.ToTable("UserDailyLogin");

            entity.HasIndex(e => new { e.UserId, e.LoginDate }, "UQ_UserDailyLogin").IsUnique();

            entity.Property(e => e.IdDailyLogin).HasColumnName("ID_DailyLogin");
            entity.Property(e => e.EarnedXp).HasColumnName("EarnedXP");
            entity.Property(e => e.UserId).HasColumnName("User_ID");

            entity.HasOne(d => d.User).WithMany(p => p.UserDailyLogins)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK_UserDailyLogin_User");
        });
        ...
        modelBuilder.Entity<UserLessonCompletion>(entity =>
        {
            entity.HasKey(e => e.IdUserLessonCompletion).HasName("PK__UserLess__77413C9B71748DAE");

            entity.ToTable("UserLessonCompletion");

            entity.HasIndex(e => new { e.UserId, e.LessonId }, "UQ_UserLesson").IsUnique();

            entity.Property(e => e.IdUserLessonCompletion).HasColumnName("ID_UserLessonCompletion");
            entity.Property(e => e.CompletedAt)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.EarnedXp)
                .HasDefaultValue(5)
                .HasColumnName("EarnedXP");
            entity.Property(e => e.LessonId).HasColumnName("Lesson_ID");
            entity.Property(e => e.UserId).HasColumnName("User_ID");

            entity.HasOne(d => d.Lesson).WithMany(p => p.UserLessonCompletions)
                .HasForeignKey(d => d.LessonId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserLesso__Lesso__6FB49575");

            entity.HasOne(d => d.User).WithMany(p => p.UserLessonCompletions)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserLesso__User___6EC0713C");
        });
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserProg__1788CC4CBB6B7EA7");
        ...
        {
            entity.HasKey(e => e.IdSetting).HasName("PK__UserSett__3A50F7D9521B5F72");

            entity.HasIndex(e => e.UserId, "UQ__UserSett__206D9191FBD2E0CA").IsUnique();
